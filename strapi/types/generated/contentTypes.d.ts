...
export interface ApiTradicionTradicion extends Struct.CollectionTypeSchema {
  collectionName: 'tradiciones';
  info: {
    displayName: 'Tradicion';
    pluralName: 'tradiciones';
    singularName: 'tradicion';
  };
  options: {
    draftAndPublish: true;
  };
